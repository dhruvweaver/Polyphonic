 ...
 */
protocol EditVCShareDelegate: UIViewController {
 ...
 */
class EditVCShare: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if (type != .artist) {
            ...
            // Pop the current view controller to return to the previous view
